...
namespace Task_1
{
    abstract class Unit
    {
        ...
        public Unit(int x, int y, int health, int maxHealth, int speed, int attack, int attackRange, char symbol, string faction) //CONSTRUCTOR
        {
            this.x = x; //Initialize everything
            this.y = y;
            this.health = health;
            this.maxHealth = health; //NB set to health initially, giving a total
            this.speed = speed;
            this.attack = attack;
        ...
        //public abstract int Speed { get; set; } //these are experimental, but not necessary
